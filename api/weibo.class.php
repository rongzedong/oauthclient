 ...
 *
 * base the PHP SDK for weibo.com (using OAuth2)
...
class api_weibo
{
	...
	function call($action, $postFields = ''){
		...
		$req["access_token"] = $this->oauth->token['access_token'];
	...
	function post($action, $postFields = ''){
		...
		$url = $this->api_url . $action . ".json";
		//echo($url);
		//print_r($req);
		$rp = $this->oauth->post($url, $req);
		//print_r($rp);
		//$response_name = str_replace('.', '_', $action) . "_response"; 
		return $rp;
	}
	...
	function public_timeline( $page = 1, $count = 50, $base_app = 0 )
	{
		...
		return $this->call('statuses/public_timeline', $params);//可能是接口的bug不能补全
	}
	...
	function home_timeline( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $base_app = 0, $feature = 0 )
	{
		...
		return $this->call('statuses/home_timeline', $params);
	}
	...
	function user_timeline_by_id( $uid = NULL , $page = 1 , $count = 50 , $since_id = 0, $max_id = 0, $feature = 0, $trim_user = 0, $base_app = 0)
	{
		...
		return $this->call( 'statuses/user_timeline', $params );
	}
	...
	function timeline_batch_by_name( $screen_name, $page = 1, $count = 50, $feature = 0, $base_app = 0)
	{
		...
		$params['base_app'] = intval($base_app);
		$params['feature'] = intval($feature);
		return $this->call('statuses/timeline_batch', $params);
	}
	...
	function show_status( $id )
	{
		...
		$params = array();
		$params['id'] = $id;
		return $this->call('statuses/show', $params);
	}
    ...
    function show_batch( $ids )
	{
		...
		return $this->call('statuses/show_batch', $params);
	}
	...
	function querymid( $id, $type = 1, $is_batch = 0 )
	{
		...
		return $this->call( 'statuses/querymid',  $params);
	}
	...
	function queryid( $mid, $type = 1, $is_batch = 0, $inbox = 0, $isBase62 = 0)
	{
		...
		return $this->call('statuses/queryid', $params);
	}
	...
	function repost_daily( $count = 20, $base_app = 0)
	{
		...
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
		return $this->call('statuses/hot/repost_daily',  $params);
	}
	...
	function repost_weekly( $count = 20,  $base_app = 0)
	{
		...
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
		return $this->call( 'statuses/hot/repost_weekly',  $params);
	}
	...
	function comments_daily( $count = 20,  $base_app = 0)
	{
		...
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
		return $this->call( 'statuses/hot/comments_daily',  $params);
	}
	...
	function comments_weekly( $count = 20, $base_app = 0)
	{
		...
		$params['count'] = intval($count);
		$params['base_app'] = intval($base_app);
		return $this->call( 'statuses/hot/comments_weekly', $params);
	}
	...
	function destroy( $id )
	{
		...
		$params = array();
		$params['id'] = $id;
		return $this->post( 'statuses/destroy',  $params );
	}
	...
	function emotions( $type = "face", $language = "cnname" )
	{
		...
		return $this->call( 'emotions', $params );
	}
	...
	function get_comments_by_sid( $sid, $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0 )
	{
		...
		$params['page'] = $page;
		$params['filter_by_author'] = $filter_by_author;
		return $this->call( 'comments/show',  $params );
	}
	...
	function comments_by_me( $page = 1 , $count = 50, $since_id = 0, $max_id = 0,  $filter_by_source = 0 )
	{
		...
		$params['page'] = $page;
		$params['filter_by_source'] = $filter_by_source;
		return $this->call( 'comments/by_me', $params );
	}
	...
	function comments_to_me( $page = 1 , $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
	{
		...
		$params['filter_by_author'] = $filter_by_author;
		$params['filter_by_source'] = $filter_by_source;
		return $this->call( 'comments/to_me', $params );
	}
	...
	function comments_mentions( $page = 1, $count = 50, $since_id = 0, $max_id = 0, $filter_by_author = 0, $filter_by_source = 0)
	{
		...
		$params['filter_by_author'] = $filter_by_author;
		$params['filter_by_source'] = $filter_by_source;
		return $this->call( 'comments/mentions', $params );
	}
	...
	function comments_show_batch( $cids )
	{
		...
		return $this->call( 'comments/show_batch', $params );
	}
	...
	function comment_destroy( $cid )
	{
		$params = array();
		$params['cid'] = $cid;
		return $this->post( 'comments/destroy', $params);
	}
	...
	function comment_destroy_batch( $ids )
	{
		...
		return $this->post( 'comments/destroy_batch', $params);
	}
	...
	function show_user_by_id( $uid )
	{
		...
		return $this->call('users/show', $params );
	}
	...
	function domain_show( $domain )
	{
		...
		return $this->call( 'users/domain_show', $params );
	}
	...
	function users_show_batch_by_id( $uids )
	{
		...
		return $this->call( 'users/show_batch', $params );
	}
	...
	function friends_by_id( $uid, $cursor = 0, $count = 50 )
	{
		...
		return $this->call( 'friendships/friends', $params );
	}
	...
	function friends_in_common( $uid, $suid = NULL, $page = 1, $count = 50 )
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'friendships/friends/in_common', $params  );
	}
	...
	function bilateral( $uid, $page = 1, $count = 50, $sort = 0 )
	{
		...
		$params['page'] = $page;
		$params['sort'] = $sort;
		return $this->call( 'friendships/friends/bilateral', $params  );
	}
	...
	function bilateral_ids( $uid, $page = 1, $count = 50, $sort = 0)
	{
		...
		$params['page'] = $page;
		$params['sort'] = $sort;
		return $this->call( 'friendships/friends/bilateral/ids',  $params  );
	}
	...
	function friends_ids_by_id( $uid, $cursor = 0, $count = 500 )
	{
		...
		$params['cursor'] = $cursor;
		$params['count'] = $count;
		return $this->call( 'friendships/friends/ids', $params );
	}
	...
	function friends_remark_batch( $uids )
	{
		...
		return $this->call( 'friendships/friends/remark_batch', $params  );
	}
	...
	function followers_by_id( $uid , $cursor = 0 , $count = 50)
	{
		...
		$params['count'] = $count;
		$params['cursor'] = $cursor;
		return $this->call( 'friendships/followers', $params  );
	}
	...
	function followers_ids_by_id( $uid, $cursor = 0 , $count = 50 )
	{
		...
		$params['count'] = $count;
		$params['cursor'] = $cursor;
		return $this->call( 'friendships/followers/ids', $params  );
	}
	...
	function followers_active( $uid,  $count = 20)
	{
		...
		$param['uid'] = $uid;
		$param['count'] = $count;
		return $this->call( 'friendships/followers/active', $param);
	}
	...
	function friends_chain_followers( $uid, $page = 1, $count = 50 )
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'friendships/friends_chain/followers',  $params );
	}
	...
	function is_followed_by_id( $target_id, $source_id = NULL )
	{
		...
		return $this->call( 'friendships/show', $params );
	}
	...
	function follow_create_batch( $uids )
	{
		...
		return $this->post( 'friendships/create_batch', $params);
	}
	...
	function update_remark( $uid, $remark )
	{
		...
		return $this->post( 'friendships/remark/update', $params);
	}
	...
	function dm_user_list( $count = 20, $cursor = 0)
	{
		...
		$params['count'] = $count;
		$params['cursor'] = $cursor;
		return $this->call( 'direct_messages/user_list', $params );
	} 
	...
	function dm_conversation( $uid, $page = 1, $count = 50, $since_id = 0, $max_id = 0)
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'direct_messages/conversation', $params );
	}
	...
	function dm_show_batch( $dmids )
	{
		...
		return $this->call( 'direct_messages/show_batch',  $params );
	}
	...
	function delete_dms( $dids )
	{
		...
		return $this->post( 'direct_messages/destroy_batch', $params);
	}
	...
	function account_profile_basic( $uid = NULL  )
	{
		...
		return $this->call( 'account/profile/basic', $params );
	}
	...
	function account_education( $uid = NULL )
	{
		...
		return $this->call( 'account/profile/education', $params );
	}
	...
	function account_education_batch( $uids  )
	{
		...
		return $this->call( 'account/profile/education_batch', $params );
	}
	...
	function account_career( $uid = NULL )
	{
		...
		return $this->call( 'account/profile/career', $params );
	}
	...
	function account_career_batch( $uids )
	{
		...
		return $this->call( 'account/profile/career_batch', $params );
	}
	...
	{
		return $this->call('account/get_privacy');
	}
	...
	function school_list( $query )
	{
		...
		return $this->call( 'account/profile/school_list', $params );
	}
	...
	{
		return $this->call( 'account/rate_limit_status' );
	}
	...
	function get_uid()
	{
		return $this->call( 'account/get_uid' );
	}
	...
	{
		return $this->post( 'account/profile/basic_update',  $profile);
	}
	...
	{
		return $this->post( 'account/profile/edu_update',  $edu_update);
	}
	...
	function edu_destroy( $id )
	{
		...
		$params = array();
		$params['id'] = $id;
		return $this->post( 'account/profile/edu_destroy', $params);
	}
	...
	{
		return $this->post( 'account/profile/car_update', $car_update);
	}
	...
	function car_destroy( $id )
	{
		...
		$params = array();
		$params['id'] = $id;
		return $this->post( 'account/profile/car_destroy', $params);
	}
	...
	function update_profile_image( $image_path )
	{
		...
		return $this->post('account/avatar/upload', $params);
	}
	...
	{
		return $this->post( 'account/update_privacy', $privacy_settings);
	}
	...
	function get_favorites( $page = 1, $count = 50 )
	{
		...
		return $this->call( 'favorites', $params );
	}
	...
	function favorites_show( $id )
	{
		...
		$this->id_format($id);
		$params['id'] = $id;
		return $this->call( 'favorites/show', $params );
	}
	...
	function favorites_by_tags( $tid, $page = 1, $count = 50)
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'favorites/by_tags', $params );
	}
	...
	function favorites_tags( $page = 1, $count = 50)
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'favorites/tags', $params );
	}
	...
	function remove_from_favorites_batch( $fids )
	{
		...
		return $this->post( 'favorites/destroy_batch', $params);
	}
	...
	function favorites_tags_update( $id,  $tags )
	{
		...
		return $this->post( 'favorites/tags/update', $params );
	}
	...
	function favorites_update_batch( $tid, $tag )
	{
		...
		$params['tid'] = $tid;
		$params['tag'] = $tag;
		return $this->post( 'favorites/tags/update_batch', $params);
	}
	...
	function favorites_tags_destroy_batch( $tid )
	{
		$params = array();
		$params['tid'] = $tid;
		return $this->post( 'favorites/tags/destroy_batch', $params);
	}
	...
	function get_trends( $uid = NULL, $page = 1, $count = 10 )
	{
		...
		$params['page'] = $page;
		$params['count'] = $count;
		return $this->call( 'trends', $params );
	}
	...
	function trends_is_follow( $trend_name )
	{
		...
		return $this->call( 'trends/is_follow', $params );
	}
	...
	function hourly_trends( $base_app = 0 )
	{
		...
		return $this->call( 'trends/hourly', $params );
	}
	...
	function daily_trends( $base_app = 0 )
	{
		...
		return $this->call( 'trends/daily', $params );
	}
	...
	function weekly_trends( $base_app = 0 )
	{
		...
		return $this->call( 'trends/weekly', $params );
	}
	...
	function follow_trends( $trend_name )
	{
		$params = array();
		$params['trend_name'] = $trend_name;
		return $this->post( 'trends/follow', $params );
	}
	...
	function unfollow_trends( $tid )
	{
		...
		return $this->post( 'trends/destroy', $params );
	}
	...
	function get_tags_batch( $uids )
	{
		...
		return $this->call( 'tags/tags_batch', $params );
	}
	...
	function get_suggest_tags( $count = 10)
	{
		$params = array();
		$params['count'] = intval($count);
		return $this->call( 'tags/suggestions', $params );
	}
	...
	function add_tags( $tags )
	{
		...
		return $this->post( 'tags/create', $params);
	}
	...
	function delete_tag( $tag_id )
	{
		...
		return $this->post( 'tags/destroy', $params );
	}
	...
	function delete_tags( $ids )
	{
		...
		return $this->post( 'tags/destroy_batch', $params );
	}
	...
	function verify_nickname( $nickname )
	{
		...
		return $this->call( 'register/verify_nickname', $params );
	}
	...
	function search_users( $q,  $count = 10 )
	{
		...
		$params['q'] = $q;
		$params['count'] = $count;
		return $this->call( 'search/suggestions/users',  $params );
	}
	...
	function search_statuses( $q,  $count = 10)
	{
		...
		$params['q'] = $q;
		$params['count'] = $count;
		return $this->call( 'search/suggestions/statuses', $params );
	}
	...
	function search_schools( $q,  $count = 10,  $type = 1)
	{
		...
		$params['count'] = $count;
		$params['type'] = $type;
		return $this->call( 'search/suggestions/schools', $params );
	}
	...
	function search_companies( $q, $count = 10)
	{
		...
		$params['q'] = $q;
		$params['count'] = $count;
		return $this->call( 'search/suggestions/companies', $params );
	}
	...
	function search_at_users( $q, $count = 10, $type=0, $range = 2)
	{
		...
		$params['type'] = $type;
		$params['range'] = $range;
		return $this->call( 'search/suggestions/at_users', $params );
	}
	...
	{
		return $this->call( 'search/statuses', $query );
	}
	...
	{
		return $this->call( 'search/users', $query );
	}
	...
	function hot_users( $category = "default" )
	{
		...
		return $this->call( 'suggestions/users/hot', $params );
	}
	...
	{   
		...
		$params['page'] = $page;
		$params['count'] = $count;
		return $this->call( 'suggestions/users/may_interested', $params);
	}
	...
	function suggestions_users_by_status( $content, $num = 10 )
	{
		...
		$params['num'] = $num;
		return $this->call( 'suggestions/users/by_status', $params);
	}
	...
	function hot_favorites( $page = 1, $count = 20 )
	{
		...
		$params['count'] = $count;
		$params['page'] = $page;
		return $this->call( 'suggestions/favorites/hot', $params);
	}
	...
	function put_users_not_interested( $uid )
	{
		$params = array();
		$params['uid'] = $uid;
		return $this->post( 'suggestions/users/not_interested', $params);
	}
